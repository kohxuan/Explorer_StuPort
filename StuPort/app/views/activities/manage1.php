                    ...
                    <?php foreach ($data['activities'] as $activity): ?>
                        <tr>
                            ...
                            if (!empty($activity->link_form)) {
                                echo '<a href="#" onclick="confirmAddFeedback(\'' . $activity->link_form . '\')">' . $activity->link_form . '</a>';
                            } else {
                            ...
                            <script>
                                function confirmAddFeedback(link) {
                                    if (confirm('There is already a feedback link. Do you want to add one more feedback?')) {
                                        // User clicked OK, redirect to create page
                                        window.location.href = URLROOT + '/feedbacks/create/?activity_id=' + <?php echo $activity->activity_id; ?>;
                                    } else {
