        ...
        <div class="table-responsive">
            ...
            <thead>
                <tr class="fw-semibold fs-6 text-muted">
                    ...
                    <th>Organizer Name</th> <!-- Added organizer_name column -->
                    <th>Skill Acquired</th> <!-- Added skill_acquired column -->
                    <th>Action</th>
                        ...
                        <td><?php echo $activity->title; ?></td>
                            ...
                            <td>
                                ...
                                if (!empty($activity->link_form)) {
                                    ...
                                    echo '<a href="' . URLROOT . '/feedbacks/create/' . $activity->activity_id . '" class="btn btn-light-primary">Add Feedback</a>';
                                }
                                ?>
                            </td>
                            <td>
