...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <!--begin::Content container-->
        ...
        <?php
                    ...
                    $t_url = URLROOT . "/badges/view"; 

                    if (isset($data['badges']) && is_object($data['badges'])) {
                    $u_url = URLROOT . "/badges/view/".$data['badges']->user_id; //Update must have id // Dynamic URL (id from database) 
                    }
                    // echo $url."<br>".$u_url;
