...
<head>
    ...
    <link href="<?php echo URLROOT ?>/public/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo URLROOT?>/public/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
        type="text/css" />

    <!--end::Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="<?php echo URLROOT ?>/public/assets/plugins/global/plugins.bundle.css" rel="stylesheet"
        type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <!--end::Theme mode setup on page load--> </body>
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="index.html" class="d-lg-none">
                            <img alt="Logo" src="<?php echo URLROOT ?>/public/assets/media/logos/default-small.svg"
                                class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                                ...
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    ...
                                    <span class="menu-link">
                                        <span class="menu-title">Welcome
											...
											echo $_SESSION['user_role'] . "<br>" . $_SESSION['username'];
											} else {
                    ...
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                        ...
                        <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="<?php echo URLROOT; ?>/pages/edit_activity" class="menu-link px-5">Activity</a>
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="<?php echo URLROOT ?>/public/assets/media/flags/spain.svg"
                                                        alt="" />
                                                </span>Spanish</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="<?php echo URLROOT ?>/public/assets/media/flags/germany.svg"
                                                        alt="" />
                                                </span>German</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="<?php echo URLROOT ?>/public/assets/media/flags/japan.svg"
                                                        alt="" />
                                                </span>Japanese</a>
                                        </div>
                                        <!--end::Menu item-->
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="<?php echo URLROOT ?>/public/assets/media/flags/france.svg"
                                                        alt="" />
                                                </span>French</a>
                                        </div>
                                        <!--end::Menu item-->
                    ...
                    <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                        ...
                        <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
                            ...
                            <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                                <!--begin::Logo image-->
                                <a href="index.html">
                                    <img alt="Logo" src="<?php echo URLROOT ?>/public/assets/media/logos/default-dark.svg"
