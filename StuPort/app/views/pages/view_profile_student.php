...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card-body">
            <?php foreach ($data['studentProfile'] as $studentProfile) : ?>
                    ...
                    <div class="card-body pt-9 pb-0">
                                        ...
                                        <div class="me-0">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3 my-1">
                                                    <a href="<?php echo URLROOT; ?>/pages/edit_profile" class="menu-link px-3">Settings</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu 3-->
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="<?php echo URLROOT; ?>/pages/view_profile">Profile</a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" href="<?php echo URLROOT; ?>/pages/edit_profile">Settings</a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--begin::Navs-->
                ...
                <!-- Profile Details -->
                <!--begin::details View-->
                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view" style="border-color: #FCBD32;">
                    <!--begin::Card header-->
                    <div class="card-header cursor-pointer" style="background-color: #FCBD32; color: white;">
                        ...
                        <!--end::Card title-->
                        <!--begin::Action-->
                        <a href="<?php echo URLROOT; ?>/pages/edit_profile" class="btn btn-sm btn-primary align-self-center" class="btn btn-light-primary" style="background-color: #183D64; color: white;">Edit Profile</a>
                        <!--end::Action-->
                    </div>
                    <!--begin::Card header-->
                    <!--begin::Card body-->
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-semibold text-muted">Headline</label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8">
                        ...
                        <div class="row mb-10">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-semibold text-muted">City/State</label>
                            <!--begin::Label-->
                            <!--begin::Label-->
                            <div class="col-lg-8">
                    ...
                    <div class="card-header cursor-pointer" style="background-color: #FCBD32; color: white;">
                        <!--begin::Card title-->
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0" style="color: white;">Academic Details</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
    ...
    <!-- <div class="text-end mt-4">
        <a href="<?php //echo URLROOT; 
                    ?>/pages/generate_resume" class="btn btn-primary" target="_blank">Download Resume</a>
    </div> -->
    </div>
</div>
